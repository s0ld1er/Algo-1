...
public class TestClass {
    ...
    public void testPalindromes() {
        ...
        //assertEquals("NONE", new PalindromeImpl().allRotations("shakira"));
        }
        System.out.println(System.currentTimeMillis() - start + " for 100k palindromes");
    ...
    public void testEncrypted() {
        ...
        /*assertEquals(
                "Send us the code you used to decode this message. Write a short text (at most one page) telling us why you decided to "
                        + "start programming. What is that you like and what motivates you to continue learning? We would also want to know "
                        + "what are your expectations for the Algorithms course. Let your thoughts flow and don't spare us any detail.",
                new EncryptedMessageImpl()
                        .decryptEncryptedMessage("TJKUMbUUJTIREuKOXD'HR.sTOVSWU!KSJ(O.sVYtWZTTZVULsNOBdYONXFsvEu(PgWJsRTSVsYKO"
                                + "fDZOJSNVWu(IU!yAaMs?OW.tYaVET.A IQXTMQURJ.HLs'VHa'OTYUSzCQ!SePzsuMTzYQ!SM!NOdOH SuPMa)yA!LsKOPEUM,VAaMs.SuKOkDJEcIIStHACKBULGARIA"
                                + "~1260~abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ .',!?()rEPNtg,yTYMsJOFOtkZ sd EKsVYtXPIOUMs HK't(PYSROEAsq.JfPyAJ HVRVC"
                                + "UYaZsPITzMQ'UMZTEJXANEBCUYWRI!Os.Su(IkD!OdADLCKNFXDZOJ THRVCQdZMRRUMPNIDtISGTJQSz"));
        */}
        System.out.println(System.currentTimeMillis() - start + " for 100k messages. ");
    }
    ...
    public void testBrackets() {
        ...
        System.out.println(System.currentTimeMillis() - start + " for 100k brackets " );
